...
async function actualizarAdmin(id, data) {
  ...
  const updatePayload = {};
  if (data.nombre !== undefined || data.ombre !== undefined) {
    updatePayload.ombre = data.ombre ?? data.nombre;
  }
  ...
  if (data.isActive !== undefined || data.isActice !== undefined) {
    updatePayload.isActice = data.isActice ?? data.isActive;
  }

      ...
      {onBack && (
        <div className="flex justify-start mb-2 sticky top-0 bg-surface/90 backdrop-blur-md py-2 z-10">
          <button
            type="button"
            onClick={onBack}
            className="text-text-secondary hover:text-brand-primary text-sm font-bold flex items-center gap-1 transition-colors bg-transparent border-none cursor-pointer"
          >

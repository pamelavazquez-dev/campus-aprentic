...
export default function Login() {
  ...
  return (
    <div className="login-aurora-shell min-h-screen flex items-center justify-center relative overflow-hidden bg-canvas">
      ...
      <div className={`bg-surface backdrop-blur-2xl border border-border-default rounded-3xl ${showSolicitud ? 'max-w-[600px] p-8 sm:p-10' : 'max-w-[440px] p-10 sm:p-12'} w-[90%] shadow-xl hover:shadow-2xl transition-all duration-500 animate-fade-in relative z-10`}>
